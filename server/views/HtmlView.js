...
let allowUnsafeNewFunction = require('loophole').allowUnsafeNewFunction;
let allowUnsafeEval = require('loophole').allowUnsafeEval;

var View = allowUnsafeNewFunction( () => require('./View')),
    qejs = allowUnsafeNewFunction(() => require('qejs')),
    q = require('q'),
    path = require('path'),
    _ = require('lodash'),
